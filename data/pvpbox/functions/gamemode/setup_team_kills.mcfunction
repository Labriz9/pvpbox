...
scoreboard objectives add TKills dummy "Team Kills"
scoreboard objectives setdisplay sidebar TKills
scoreboard objectives add AKills playerKillCount
scoreboard players set @a AKills 0
...
execute as @a[team=Guardian] run scoreboard players set Guardian TKills 0
execute as @a[team=Conqueror] run scoreboard players set Conqueror TKills 0
execute as @a[team=Futurist] run scoreboard players set Futurist TKills 0

function pvpbox:gamemode/team_kills
